...
import GSAP from "../../Assets/TechIcons/GSAP.png";
import Canva from "../../Assets/TechIcons/Canva.webp";

function Techstack() {
  return (
    <Row style={{ justifyContent: "center", paddingBottom: "50px" }}>
      <Col xs={4} md={2} className="tech-icons" >
        <img src={HTML} alt="HTML" style={{height:"3vh"}} />
        <div className="tech-icons-text" style={{width:"5vw"}}>HTML</div>
      </Col>
      <Col xs={4} md={2} className="tech-icons">
      ...
      <Col xs={4} md={2} className="tech-icons">
        <img src={CSS} alt="CSS" style={{height:"3vh"}} />
        <div className="tech-icons-text">CSS</div>
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <img src={PHP} alt="PHP" style={{height:"3vh"}} />
        <div className="tech-icons-text">PHP</div>
      </Col>
      <Col xs={4} md={2} className="tech-icons">
        <img src={MySQL} alt="MySQL" style={{width:"1.5vw"}}/>
      ...
      <Col xs={4} md={2} className="tech-icons">
        <img src={GSAP} alt="GSAP" style={{height:"3vh"}} />
        <div className="tech-icons-text"  style={{width:"5vw"}}>GSAP</div>
      </Col>
      ...
      <Col xs={4} md={2} className="tech-icons">
        <img src={Canva} alt="Canva"  style={{height:"3vh"}} />
